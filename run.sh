...
# g++ main.cpp Get_films/Get_films.cpp Get_year/Get_year.cpp Get_rating/Get_rating.cpp Get_local/Get_local.cpp Sort_films/Sort_films.cpp -o build/out
# chmod +x build/out
...
# ./build/main -find_year 1895 -path_to_year data/title.basics.tsv -path_to_rating data/title.ratings.tsv -path_to_name data/title.akas.tsv